...
import {Button, Empty, notification, message, Avatar, Icon, Tooltip} from "ant-design-vue";
//
Vue.prototype.$notification = notification;
Vue.prototype.$message = message;

/*需要注册的组件名字, 注册之前需要确保已经import这个组件*/
const components = [Button, Empty, notification, message, Avatar, Icon, Tooltip];
register(components);
